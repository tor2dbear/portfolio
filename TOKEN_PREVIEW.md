# Token Preview (New Canonical + Legacy Replacement)

This is a final review snapshot of the canonical tokens and how legacy
tokens will be replaced.

## Canonical Tokens (Reference)
...
- Legacy layer can be removed once you confirm no legacy tokens are used.
- Canonical tokens are defined in `assets/css/tokens/semantic.css`.
- The mapping remains one-to-one for safe fallback if you re-enable legacy.css.
