...
// Generated by a Hugo template outside assets/css (so not collected here): the
// per-work-theme colour scale + role tokens from
// assets/templates/work-theme-scales.css (data/work-themes.toml).
const TEMPLATE_GENERATED_PREFIXES = ["--work-"];
...
function isAllowlisted(varName) {
  ...
  return [...JS_SET_PREFIXES, ...TEMPLATE_GENERATED_PREFIXES].some((p) =>
