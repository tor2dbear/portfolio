...
Där sitter åsiktslagret, och det är hela poängen. Du kan signera med plånbok, eller — i den fullständiga versionen — göra verket till en NFT. Det undergräver inte verket; det _fullbordar_ satiren: att betala riktiga pengar för att tillverka ägande och knapphet åt något som aldrig var nytt. En global räknare visar hur många gånger _just det verket_ redan har signerats. Det du nyss gjorde till ditt hade redan plockats av andra.
